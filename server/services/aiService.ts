...
export const aiService = {
    ...
    generateOfflineResponse: (query: string): string => {
        ...
        if (q.includes("brit") || q.includes("bris") || q.includes("ברית")) return "For a Bris, keep it elegant and soft. White or cream tablecloths with light blue velvet runners, silver mercury vase centerpieces, and crystal candle holders create a beautiful serene atmosphere.";
